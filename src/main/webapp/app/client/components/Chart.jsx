...
class Chart extends React.Component {
            ...
            themesConf: {
                ...
                "default": {
                    "tradingView": {
                        ...
                        "toolbarBg": "#fff",
                        "customCssUrl": "/resources/css/tradingview-style/style.css",
                        "OVERRIDES": {
                ...
                "black": {
                    "tradingView": {
                        ...
                        }, "toolbarBg": "#2d2d2d", "customCssUrl": "/tradingview-style/dark-style.css", "OVERRIDES": {
                    ...
                    "TokenChangeModalCtrl": {"seriesColor": "rgba(255,255,255,0.80)"},
                    "bgColor": "#fff"
                }
            }
        }
    ...
    componentWillReceiveProps(nextProps) {
        if (nextProps.symbol != this.state.symbol) {
            ...
            this.setState({symbol: nextProps.symbol}, () => {
                if (widget) {
                    window[id].setSymbol(nextProps.symbol, window[id].symbolInterval().interval);
                }
            })
        }
    ...
    renderChartHeader() {
        if (this.props.modal) {
            let imagePath = "/resources/img/orderbook/{imageName}".replace("{imageName}", this.props.imageName);
            return (
