...
const IndexNav = (_) => {
  ...
  const setActive = useCallback(
    (payload) => dispatch({ type: "SetHomeActive", payload }),
    [dispatch]
  );
  const setPair = useCallback((_) => dispatch({ type: "SetHomePair" }), [
    dispatch,
  ]);
  const setExchange = useCallback(
    (_) => dispatch({ type: "SetHomeExchange" }),
    [dispatch]
  );
  const setChart = useCallback((_) => dispatch({ type: "SetHomeChart" }), [
    dispatch,
  ]);
  const setHistory = useCallback((_) => dispatch({ type: "SetHomeHistory" }), [
    dispatch,
  ]);
  const setOrderbook = useCallback(
    (_) => dispatch({ type: "SetHomeOrderbook" }),
    [dispatch]
  );
  ...
  return (
    <div className="index-nav">
      <div
        className={`index-nav-item js-index-nav ${classes[0]}`}
        data-nav="pair"
        onClick={setPair}
      >
        <div className="icon">
      ...
      <div
        className={`index-nav-item js-index-nav ${classes[1]}`}
        data-nav="exchange"
        onClick={setExchange}
      >
        <div className="icon">
      ...
      <div
        className={`index-nav-item js-index-nav ${classes[2]}`}
        data-nav="chart"
        onClick={handleChart}
      >
        <div className="icon">
      ...
      <div
        className={`index-nav-item js-index-nav ${classes[3]}`}
        data-nav="history"
        onClick={setHistory}
      >
        <div className="icon">
      ...
      <div
        className={`index-nav-item js-index-nav ${classes[4]}`}
        data-nav="orderbook"
