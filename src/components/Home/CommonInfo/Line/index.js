		...
		(_) => {
			if (tickers[pair]) {
				price.getCryptoPrice('USD', assetB).then((object) => {
					...
					let last = (Number(tickers[pair].lastPrice) * object.price).toFixed(2);
					setDollars({
						...dollars,
						last: last,
						vol: vol
	...
	return (
		<div className="line">
			...
			<div className="cell short">
				...
				<div className="text">
					<span className="emp">{tickers[pair] ? tickers[pair].lastPrice : 0}</span>
			...
			<div className="cell short">
				...
				<div className="text">
					<span className="emp">
						{tickers[pair] ? formatNumber(tickers[pair].vol24h) > 1000000 ? (
			...
			<div className="cell chg">
				{change24h >= 0 ? (
					<img src="./img/growth.png" alt="home" style={{ width: '10px', height: '10px' }} />
				) : (
					<img src="./img/red-arrow.png" style={{ width: '10px', height: '10px' }} alt="home" />
				)}
				<p>
