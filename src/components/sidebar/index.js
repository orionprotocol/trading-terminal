...
export default function Sidebar() {
    ...
    const[activeComponent, setActiveComponent]=useState({selected:"selected-component",painted:['active','','']})
                ...
                <nav className="sidebar" onMouseEnter={openSidebar} onMouseLeave={closeSidebar}>
                    <div className="sidebar-content">
                        ...
                        <div className='sidebar-night-close' onClick={changeTheme}>
                            <img src={night}  />
                            <span className={show.sidebarLetters} style={{color: 'rgb(114,112,127)'}}>Dark Mode</span>
                        </div>

                        
                        <div className='sidebar-navigation-icons-close' >

                        <div className={activeComponent.selected}></div>

                            <div className="sidebar-navigation-tabs ">
                                <Link className={`sidebar-nav-link ${activeComponent.painted[0]}`}  to="/" onClick={()=> setActiveComponent({selected:'selected-component ',painted:["active","",""]})} >
                            ...
                            <div className="sidebar-navigation-tabs">
                                ...
                                <Link className={`sidebar-nav-link ${activeComponent.painted[1]}`}  to="/dashboard" onClick={()=> setActiveComponent({selected:'selected-component dashboard',painted:["","active",""]})} >
                            ...
                            <div className="sidebar-navigation-tabs">
                            <Link className={`sidebar-nav-link ${activeComponent.painted[2]}`}  to="/history" onClick={()=> setActiveComponent({selected:'selected-component history',painted:["","","active"]})} >
                        ...
                        <div className="sidebar-crypoto-icons-close">
                            <div className="sidebar-coin">
                                <img src={bitAside}  />
                                <span style={{color: 'rgb(114,112,127)'}}  className={show.sidebarLetters}>Bitcoin</span>
                            </div>
                            <div className="sidebar-coin">
                                <img src={ethAside}  />
                                <span style={{color: 'rgb(114,112,127)'}} className={show.sidebarLetters}>Ethereum</span>
                                </div>
                            <div className="sidebar-coin">
                                <img src={dashSmall}  />
                                <span style={{color: 'rgb(114,112,127)'}} className={show.sidebarLetters}>Dash</span>
                            </div>
                        </div>
                        <div className="sidebar-wallet">
                            <button className='sidebar-button-add' >
                                <img className='sidebar-add' src={add}  /><span className={show.sidebarLetters} style={{color: 'rgb(114,112,127)'}}>Add Wallet</span>
                            </button>
