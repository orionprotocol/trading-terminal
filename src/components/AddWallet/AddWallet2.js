            ...
            <div className="tabs">
              {tabs.wallet[1] ? (
                <div className="tab-metamask tab">
                  {walletOpt === "wanchain" ? (
                    <p className="desc">
                      Trade tokens on the Wanchain blockchain using the WanMask
                      browser extension.
                    </p>
                  ) : null}
                  {walletOpt === "ethereum" ? (
                    <p className="desc">
                      Trade tokens on the Ethereum blockchain using the {opt}{" "}
                      browser extension.
                    </p>
                  ) : null}
                  <div className="connect">
                    ...
                    <p className="allow">
                      Allow Orion to connect to {opt} to begin.
                    </p>
                  </div>
                  <p className="recommend">
                    This is a recommended trading method. All transaction
                    signing is done within the {opt} extension, and private keys
