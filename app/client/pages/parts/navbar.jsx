...
export default class navbar extends Component {
	...
	render() {
		...
		if (pathName === '/') {
			className1 = 'icon-active';
		} else if (pathName === '/balance') {
			className2 = 'icon-active';
		}
			...
			<div className="navbar">
				<div className="container-1">
					...
					<a style={{ color: '#111' }} href="/balance">
						<div style={{ display: 'inline-block', fontSize: '28px' }} className={className2}>
							<i className="fas fa-wallet" />
						</div>
					</a>

					<a style={{ color: '#111' }} href="/">
						<div style={{ display: 'inline-block', fontSize: '28px' }} className={className1}>
				...
				<div className="container-2">
					...
					>
						<i style={{ fontSize: '28px' }} className="fas fa-cog" />
					</a>
				</div>
